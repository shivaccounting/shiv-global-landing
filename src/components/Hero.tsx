          ...
          <div className="space-y-8 animate-slide-up">
            <div className="space-y-4">
              ...
              <p className="text-xl text-muted-foreground leading-relaxed">
                Affordable bookkeeping, payroll, tax support, and law firm trust accounting — 
                trusted by CPAs, accountants, and small businesses across the United States.
              </p>
            </div>
            ...
            <div className="pt-8">
              <p className="text-sm text-muted-foreground mb-4 font-semibold">
                "Trusted by CPAs, Bookkeepers, Law Firms, and Small Businesses Nationwide"
              </p>
              <div className="flex flex-wrap gap-6 items-center opacity-60">
                {["QuickBooks", "Xero", "Clio", "ADP", "Gusto", "Shopify"].map((platform) => (
                  <div key={platform} className="text-sm font-semibold text-primary">
                    {platform}
                  </div>
                ))}
              </div>
          ...
          <div className="relative animate-slide-down">
            ...
            <div className="absolute -bottom-6 -left-6 bg-card p-6 rounded-xl shadow-professional-lg border border-border">
              <div className="space-y-2">
                ...
                <div className="text-sm text-muted-foreground">Managed Monthly</div>
              </div>
            </div>
          </div>
        </div>
