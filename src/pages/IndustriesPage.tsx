...
const IndustriesPage = () => {
  ...
  return (
    <>
      ...
      <meta name="description" content="Specialized accounting and bookkeeping services for restaurants, retail, law firms, e-commerce, transportation, healthcare, and manufacturing industries." />
      <meta name="keywords" content="industry accounting, restaurant bookkeeping, retail accounting, law firm accounting, e-commerce bookkeeping, transportation accounting, healthcare accounting, manufacturing accounting" />
        ...
        <section className="py-20 px-4 bg-gradient-to-br from-primary/5 via-secondary/5 to-accent/5">
          <div className="max-w-7xl mx-auto text-center">
            ...
            <p className="text-sm text-muted-foreground mt-6">
              Serving US businesses since 2019 — QuickBooks, Xero, Clio, ADP, and industry-specific expertise.
            </p>
          </div>
        </section>
          ...
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
                Specialized accounting solutions tailored to the unique needs of your industry
              </p>
            </div>
            ...
            <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
              {industries.map((industry) => {
                ...
                return (
                  <Card key={industry.id} className="hover-scale transition-all duration-300 hover:shadow-lg">
                    <CardHeader>
        ...
        <section className="py-20 px-4 bg-gradient-to-r from-primary/10 via-secondary/10 to-accent/10">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-muted-foreground mb-8">
              Get a customized accounting solution designed for your industry's unique requirements.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button size="lg" className="hover-scale">
